  ...
  <div class="register container">
    ...
    <form>
      <div class="form-group row">
        <label for="username" class="col-sm-3 col-3 col-form-label customLabel">昵称</label>
      ...
      <div class="form-group row">
        <label for="inputPassword" class="col-sm-3 col-3 col-form-label customLabel">密码</label>
        <div class="col-sm-9 col-9">
